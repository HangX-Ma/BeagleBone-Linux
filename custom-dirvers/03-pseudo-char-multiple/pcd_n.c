...
struct pcdrv_private_data pcdrv_data = {
    ...
    .pcdev_data = {
        [0] = {
            ...
            .serial_number = "PCDEV1MCONTOUR",
            .perm = RDONLY
        },
        [1] = {
            .buffer = device_buffer_pcdev2,
            .size   = MEM_SIZE_MAX_PCDEV2,
            .serial_number = "PCDEV2MCONTOUR",
            .perm = WRONLY
        },
        [2] = {
            .buffer = device_buffer_pcdev3,
            .size   = MEM_SIZE_MAX_PCDEV3,
            .serial_number = "PCDEV3MCONTOUR",
            .perm = RDWR
        },
        [3] = {
            .buffer = device_buffer_pcdev4,
            .size   = MEM_SIZE_MAX_PCDEV4,
            .serial_number = "PCDEV4MCONTOUR",
            .perm = RDWR
        }
    }
};
...
static int __init pcd_driver_init(void) {
    ...
    for(i = 0; i < NO_OF_DEVICES; i++) {
        ...
        pcdrv_data.pcdev_data[i].cdev.owner = THIS_MODULE; // THIS_MODULE denotes the address of __this_module variable
