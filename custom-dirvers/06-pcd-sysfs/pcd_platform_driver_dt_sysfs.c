...
/* max_size: user can read or change the value of size information */
/* serial_num: user just reads the serial number of the device */
...
// -------------------- OF style matching --------------------
    ...
    /* 3. save the device private data pointer in platform device structure */
